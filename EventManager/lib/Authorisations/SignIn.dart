...
class _SignInState extends State<SignIn> {
  ...
  // List results;
   ...
   int port = 5432;
   String databaseName = "d4fhqs5e9ortv0";
  String userName = "jgzpyzzfwjfhan";
   String hostURL = "ec2-44-199-86-61.compute-1.amazonaws.com";
  String password =
      "49ecf0b994e77923c91a29f3e363387d9911e860559eefc7a8e36b52df0d3b0c";

  //int port = 5432;
  //String databaseName = "database-1";
  //String userName = "masterdb";
  //String hostURL = "sampledb.cfz7ogpntpdk.ap-south-1.rds.amazonaws.com";
  //String password =
     // "	e861ed26af01c2b3e3a84281cf3dbf34f36fe80694872399199631300ecfb6ad";
  ...
  nextPage(String email) async {
    ...
    if (isAdmin) {
      print("Welcome, Admin");
      toastMessage("Welcome, Admin"); // just shows this message at the bottom of the page
      ...
      await Navigator.push(
          context,
          MaterialPageRoute(
              builder: (context) => FestDetails(_user, _postgresKonnection))); //Displaying the Fest Details page.
    } else {
