...
class _AdminAddAEventState extends State<AdminAddAEvent> {
  ...
  TextEditingController _calendar = new TextEditingController();
    ...
    if (_addEventFormKey.currentState.validate()) {
      ...
      try {
        await _konnection.transaction((ctx) async {
          ...
          await ctx
              .query('''
              INSERT INTO evento(event_id,event_name,start_date_time,end_date_time,register_start_date_time,register_end_date_time,place,short_description,description,participant_limit,price,calendar) VALUES(@a,@b,@c,@d,@e,@f,@g,@h,@i,@j,@k,@l)
            ''',
              substitutionValues: {
                "a": event_id.toString(),
                "b": _event_name.text,
                          ...
                          Padding(
                            ...
                            child: new TextFormField(
                                ...
                                decoration: textInputDecoration(
                                    ...
                                    "Add Google Calendar link of event"),
                                textInputAction: TextInputAction.next,
